...
int main() {
	...
	std::string buffer;  // Èñïîëüçóåì std::string äëÿ áóôåðà
	const char* message = "Enter number to choose action: 1-Patient 2-advance time 3-exit programm";
	char recv_buffer[1024] = { 0 };  // Áóôåð äëÿ ïîëó÷åíèÿ äàííûõ ÷åðåç recv()
	...
	// Ïðèâÿçêà ñîêåòà ê IP-àäðåñó è ïîðòó
	...
	// Ïðîñëóøèâàíèå âõîäÿùèõ ïîäêëþ÷åíèé
